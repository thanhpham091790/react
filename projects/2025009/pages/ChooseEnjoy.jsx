    ...
    return (
        <section className="choose-enjoy">
            <div className="container">
                <p className="slogan">Always tastey burger</p>
                <h2 className="heading">Choose & Enjoy</h2>
                <p className="para">Whether you crave classNameic flavors or daring combinations, our burgers are crafted to
                    satisfy every
                    taste
                ...
                <div className="cards">
                    <div className="card">
                        ...
                        <p className="para">Sink your teeth into the timeless perfection of our Chicken Burgers, where
                            tender, juicy
                            chicken
                            meets fresh, flavorful
                            toppings—an unforgettable experience that never goes out of style</p>
                    ...
                    <div className="card">
                        ...
                        <p className="para">Embrace the vibrant flavors of our Veggie Delight Burger, a celebration of
                            freshness and
                            wholesome goodness, where
                            crunchy vegetables, savory sauces, and a perfectly seasoned patty come together to create a
                            mouthwatering experience for
                            every bite.</p>
                        <button type="button" className="btn">Order Now</button>
                    </div>
                    <div className="card">
                        ...
                        <p className="para">Indulge in a symphony of smoky, savory flavors with our BBQ Bacon Burger,
                            grilled to
                            perfection
                            and topped with crispy
                            bacon, melted cheese, and a smoky BBQ sauce that enhances every bite, delivering a
                            satisfying
                            blend of textures and
                            rich, heading flavors.</p>
                        <button type="button" className="btn">Order Now</button>
                    </div>
                </div>
            </div>
